...
Write-Host "[1/1] TWSE 40-day return-rank walk-forward validation"
python -m research.institutional_model.cli phase6b `
    --output-dir $twseOutput @args
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

Write-Host "TWSE 40-day validation passed. Report: research/output/twse/phase6b_twse_40d_validation_reports.zip"
